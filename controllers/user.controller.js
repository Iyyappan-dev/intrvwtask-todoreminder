...
exports.fetch_todo = async function (req, res, next) {
	...
	var limit = req.params.limit ? req.params.limit : 10;
	try {
		var users = await UserService.fetch_todo({}, page, limit, req, res)
	} catch (e) {
		return res.status(400).json({ status: 400, message: e.message });
	}
}
...
exports.insert_todo = async function (req, res, next) {
	...
	var limit = req.params.limit ? req.params.limit : 10;
	try {
		var users = await UserService.insert_todo({}, page, limit, req, res)
	} catch (e) {
		return res.status(400).json({ status: 400, message: e.message });
	}
}	
...
exports.delete_todo = async function (req, res, next) {
	...
	var limit = req.params.limit ? req.params.limit : 10;
	try {
		var users = await UserService.delete_todo({}, page, limit, req, res)
	} catch (e) {
		return res.status(400).json({ status: 400, message: e.message });
	}
}
...
exports.update_todo = async function (req, res, next) {
	...
	var limit = req.params.limit ? req.params.limit : 10;
	try {
		var users = await UserService.update_todo({}, page, limit, req, res)
	} catch (e) {
		return res.status(400).json({ status: 400, message: e.message });
	}
}
...
exports.restore_todo = async function (req, res, next) {
	...
	var limit = req.params.limit ? req.params.limit : 10;
	try {
		var users = await UserService.restore_todo({}, page, limit, req, res)
	} catch (e) {
		return res.status(400).json({ status: 400, message: e.message });
	}
}
